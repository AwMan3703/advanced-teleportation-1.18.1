package net.awman.advancedtp.block;

import net.fabricmc.fabric.api.item.v1.FabricItemSettings;
import net.fabricmc.fabric.api.object.builder.v1.block.FabricBlockSettings;
import net.awman.advancedtp.TutorialMod;
import net.awman.advancedtp.block.custom.*;
import net.awman.advancedtp.item.ModItemGroup;
...
public class ModBlocks {
    public static final Block MYTHRIL_BLOCK = registerBlock("mythril_block",
            ...
            ModItemGroup.MYTHRIL, "tooltip.advancedtp.mythril_block");
