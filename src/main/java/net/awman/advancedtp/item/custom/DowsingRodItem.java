package net.awman.advancedtp.item.custom;

import net.awman.advancedtp.item.ModItems;
import net.awman.advancedtp.util.InventoryUtil;
import net.awman.advancedtp.util.ModTags;
...
public class DowsingRodItem extends Item {
    ...
    public ActionResult useOnBlock(ItemUsageContext context) {
        if(context.getWorld().isClient()) {
            ...
            if(!foundBlock) {
                player.sendMessage(new TranslatableText("item.advancedtp.dowsing_rod.no_valuables"), false);
            }
        }
    ...
    private void addNbtToDataTablet(PlayerEntity player, BlockPos pos, Block blockBelow) {
        ...
        nbtData.putString("advancedtp.last_ore", "Found " + blockBelow.asItem().getName().getString() + " at (" +
    ...
    public void appendTooltip(ItemStack stack, @Nullable World world, List<Text> tooltip, TooltipContext context) {
        if(Screen.hasShiftDown()) {
            tooltip.add(new TranslatableText("item.advancedtp.dowsing_rod.tooltip.shift"));
        } else {
            tooltip.add(new TranslatableText("item.advancedtp.dowsing_rod.tooltip"));
        }
    }
